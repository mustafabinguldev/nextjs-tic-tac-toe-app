                ...
                <section class="mb-32">
                    <div class="flex flex-col items-center justify-center px-auto my-1 py-0	 mx-auto">
                        <div>
                            ...
                            <a onClick={() => {
                                restart();
                            }} class="mt-10 ml-12 text-4xl cursor-pointer inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                                Restart
